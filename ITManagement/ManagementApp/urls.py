...
urlpatterns = [
    ...
    path('machines/<pk>/update/', views.machine_update, name='machine_update'),
    ...
    path('infrastructures/<pk>/update/', views.infrastructure_update, name='infrastructure_update'),
    ...
    path('utilisateurs/add/', views.utilisateur_create, name='utilisateur_create'),
